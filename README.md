...
![alt text](https://github.com/igormachado/ignite-template-database-queries/blob/main/desafio-database01.png?raw=true)
...
- **[UsersRepository] should be able to find user with games list by user's ID**
    ...
    Para que esse teste passe, você deve satisfazer o código de acordo com o que é descrito no
